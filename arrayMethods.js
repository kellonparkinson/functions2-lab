...
// CODE HERE
const evenNumbers = mixedNumbers.filter(val => val % 2 === 0)
...
// CODE HERE
const postTaxPrices = prices.map(val => val + 1.07)
...
// CODE HERE
const orderTotals = orders.map(obj => obj.price * (obj.tax + 1))
...
// CODE HERE
const bobsTotal = purchases.filter(obj => obj.owner === 'Bob').reduce((acc, curr) => acc + curr.price, 0)
